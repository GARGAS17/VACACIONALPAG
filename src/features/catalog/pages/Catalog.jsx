...
import { NotificationFactory } from '../../../shared/services/notificationBridge';
import { AuditEnrollmentProxy } from '../../billing/infrastructure/proxies';
import { PriceCalculatorFactory } from '../domain/PriceDecorator';
import { UIFactoryProvider } from '../../../shared/components/uiFactory';
import { CourseQueryBuilder } from '../application/courseQueryBuilder';
import { EntityFlyweightFactory } from '../../admin/domain/EntityFlyweightFactory';

import ProfileView from '../../../shared/components/dashboard/ProfileView';
import PaymentsView from '../../billing/components/PaymentsView';
import MyCoursesView from '../../enrollments/components/MyCoursesView';
import SettingsView from '../../../shared/components/dashboard/SettingsView';
import HelpView from '../../../shared/components/dashboard/HelpView';
